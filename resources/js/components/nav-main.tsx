...
interface ShopMenuItems {
    shopMainNavItems: (slug: string) => NavItem[];
    shopCatalogueNavItems: (slug: string) => NavItem[];
    shopManageNavItems: (slug: string) => NavItem[];
}
...
export function NavMain({ menuItems, shopMenuItems }: NavMainProps) {
