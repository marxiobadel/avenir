...
export const CartSheet = ({ cart }: CartSheetProps) => {
    ...
    return (
        <Sheet>
            ...
            <SheetContent side="right" className="w-full sm:w-100 flex flex-col p-0">
                        ...
                        <div className="flex flex-col gap-6 py-6">
                            {cartItems.map((item) => (
                                <div key={item.id} className="flex gap-4">
                                    {/* Image */}
                                    <div className="h-20 w-20 shrink-0 overflow-hidden rounded-md border border-stone-200 bg-stone-50">
                                        <img
                                    ...
                                    <div className="flex flex-1 flex-col justify-between">
                                        ...
                                        <div className="flex items-center justify-between mt-2">
                                            <div className="flex items-center border border-stone-200 rounded-md h-8">
                                                ...
                                                <span className="px-2 text-xs font-medium min-w-6 text-center">
                                                    {item.quantity}
                                                </span>
                                                <button
                                                    onClick={() => updateQuantity(item.id, item.quantity + 1)}
                ...
                {itemsCount > 0 && (
                    <div className="border-t bg-stone-50 p-4 space-y-4">
                        ...
                        <div className="grid gap-2">
                            ...
                            <SheetClose asChild>
                                <Button onClick={() => {}} variant="outline" className="w-full h-11 border-stone-200">
