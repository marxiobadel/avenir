...
export const authInputClassNames = (...arr: Array<string | false | null | undefined>): string => {
    return classNames("block w-full px-4 py-3 rounded-xl border border-slate-300 bg-white/70 backdrop-blur-sm focus:bg-white placeholder-slate-400 focus:outline-none focus:ring-[3px] sm:text-sm transition-all pr-10 shadow-sm", ...arr);
};
