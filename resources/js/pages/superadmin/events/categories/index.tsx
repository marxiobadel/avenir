...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: "Catégories d'évènements", href: '#' },
];
...
export default function Index({ categories, listCategories, filters }: PageProps) {
    ...
    const columns = useMemo<ColumnDef<Category>[]>(() => [
        ...
        },
        {
            ...
            header: 'Événements',
            cell: ({ row }) => row.original.events_count ?? 0,
        },
        {
            accessorKey: 'status',
            header: "Statut",
    ...
    return (
        <AppLayout breadcrumbs={isMobile ? [] : breadcrumbs}>
            <Head title="Catégorie d'évènements" />
            <EventsLayout>
                <div className="space-y-6 md:mt-[-77px]">
                    ...
                    <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">Gérez les catégories d'évènements.</p>
                        </div>
