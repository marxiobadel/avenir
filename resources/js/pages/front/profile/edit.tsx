...
import { LoaderCircle, ShieldAlert, Upload, X } from "lucide-react";
            ...
            <ProfileLayout>
                <form onSubmit={handleSubmit} className="flex flex-col flex-1 space-y-4">
                    ...
                    <div className="flex flex-col lg:flex-row items-start gap-6">
                        <div className="w-full lg:w-75 mb-4 lg:mb-0">
                            ...
                            <div>
                                ...
                                {errors.lastname && (
                                    <div className="mt-2 flex items-center gap-1 text-red-500">
                                        <ShieldAlert size={14} />
                                        <p className="text-xs font-medium">{errors.lastname}</p>
                                    </div>
                                )}
                            </div>
                            <div>
                                ...
                                {errors.firstname && (
                                    <div className="mt-2 flex items-center gap-1 text-red-500">
                                        <ShieldAlert size={14} />
                                        <p className="text-xs font-medium">{errors.firstname}</p>
                                    </div>
                                )}
                            </div>
                            <div>
