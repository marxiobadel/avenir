            ...
            <DialogContent className="sm:max-w-xl max-h-[90vh] overflow-y-auto" aria-describedby="address-dialog-description">
                ...
                <form onSubmit={handleSubmit} className="space-y-4 mt-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        {/* Position */}
                        <div>
                            <Label htmlFor="name" className="font-medium text-sm">Nom ou Raison sociale</Label>
                            <Input
                                id="name"
                                value={form.data.name}
                                onChange={(e) => form.setData("name", e.target.value)}
                                placeholder="Ex: John Doe ou Entreprise XYZ"
                                className={cn("mt-1", inputClassNames())}
                            />
                        ...
                        <div className="flex flex-col">
                            <Label htmlFor="country_id" className="font-medium text-sm mb-2">
                                Pays
                            </Label>
