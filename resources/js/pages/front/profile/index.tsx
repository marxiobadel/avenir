        ...
        <AppLayout layout="guest">
            ...
            <ProfileLayout>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center justify-between p-3 rounded-lg bg-stone-50/50 border border-stone-100/50">
                                    <div className="flex flex-col">
                                        ...
                                        <span className="text-sm font-semibold text-stone-900 truncate max-w-50">{auth.user.email}</span>
                                    </div>
                    ...
                    {/* Carte Sécurité / Info */}
                    <div className="rounded-2xl bg-linear-to-br from-stone-900 to-stone-800 text-white p-6 shadow-xl flex flex-col justify-between">
                        <div>
